$(document).ready(function () {
    ...
    function DensityField( time ) {
        ...
        for ( var i = 0; i < WIDTH; i++ ) {
            for ( var j = 0; j < WIDTH; j++ ) {
                var color = getColourDensity(window.arrData[time][i][j]['p'], 0.8, 0);
     ...
     */
     function PressureField( time ) {
       ...
       for ( var i = 0; i < WIDTH; i++ ) {
           for ( var j = 0; j < WIDTH; j++ ) {
               var color = getColourPressure(window.arrData[time][i][j]['P'], 0.8, 0);
    ...
    function TemperatureField( time ) {
        ...
        for ( var i = 0; i < WIDTH; i++ ) {
            for ( var j = 0; j < WIDTH; j++ ) {
                var color = getColourTemperature(window.arrData[time][i][j]['T'], 1.5, 0);
